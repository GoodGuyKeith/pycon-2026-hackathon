...
DOC_KEYWORDS = {
  ...
  "JUDGE_PACKET.md": ["Fast Review Path", "What To Click In The Demo", "Criteria Evidence", "Honest Boundaries"],
  "LICENSE": ["MIT License", "Event Buddy contributors"],
  "HACKATHON_SUBMISSION.md": ["Data Quality", "User Focus", "Technical Execution"],
  "SUBMISSION_FORM_DRAFT.md": ["Problem", "Solution", "Honest Limitations"],
  "JUDGING_CHECKLIST.md": ["Criteria Evidence", "session code", "Known Limitations", "Last Local Verification"],
  "SUBMISSION_AUDIT_REPORT.md": ["Criteria Audit", "make pages-preview-check", "make final-preflight", "Verification Gates", "Remaining User-Only Actions"],
  "SUBMISSION_READINESS.md": ["Official Fit", "Repo-Ready Evidence", "make final-preflight", "session code", "External Actions Still Required"],
  "DEMO_SCRIPT.md": ["Two-Minute Demo Script", "Upload schedule", "Recommendation Logic", "Backend Proof"],
  "PITCH_DECK.md": ["Problem", "Solution", "Honest Limitations"],
  "FINAL_HANDOFF.md": ["Final Pre-Submit Commands", "Submission Steps Still Requiring User Action", "Do Not Overclaim"],
  "SUBMISSION_LINKS_TEMPLATE.md": ["Public repository URL", "GitHub Pages static preview URL", "Form Submission Checks"],
  "FORM_INSPECTION.md": ["Google sign-in", "public project repo", "24 Jun 2026"],
  "PUBLIC_REPO_CHECKLIST.md": ["Before Publishing", "Do not commit generated/local files", "Recommended Repo Description"],
  "GITHUB_PUBLISH_GUIDE.md": ["Recommended Repository Settings", "Publish With Git", "make repo-preflight", "make pages-preview-check", ".github/workflows/check.yml", ".github/workflows/pages.yml", "Final Sanity Check"],
  "DEPLOYMENT.md": ["Recommended Judged Demo", "Static Preview Mode", "make pages-preview-check", ".github/workflows/pages.yml", "Container Option"],
  "AI_USE_AND_ETHICS.md": ["How AI Was Used", "Data And Privacy", "Fairness And Limitations"],
  "AI_READY_ASEAN.md": ["Understanding Of AI Concepts", "Effective AI Tool Use", "Ethical AI Tool Use"],
  "SOURCES.md": ["Official Hackathon References", "Local Resource Links", "Provenance Notes"]
}
...
def audit_manifest():
  ...
  assert_true("JUDGE_PACKET.md" in data.get("submissionFiles", []), "manifest should list judge packet")
  ...
  assert_true("assets/demo-screenshot.jpg" in data.get("submissionFiles", []), "manifest should list the demo screenshot")
  ...
  assert_true("SUBMISSION_AUDIT_REPORT.md" in data.get("submissionFiles", []), "manifest should list submission audit report")
  assert_true("FORM_INSPECTION.md" in data.get("submissionFiles", []), "manifest should list the form inspection notes")
  assert_true("PUBLIC_REPO_CHECKLIST.md" in data.get("submissionFiles", []), "manifest should list public repo checklist")
  assert_true("GITHUB_PUBLISH_GUIDE.md" in data.get("submissionFiles", []), "manifest should list GitHub publish guide")
  assert_true("DEPLOYMENT.md" in data.get("submissionFiles", []), "manifest should list deployment guide")
  assert_true("AI_USE_AND_ETHICS.md" in data.get("submissionFiles", []), "manifest should list AI use and ethics notes")
  assert_true("AI_READY_ASEAN.md" in data.get("submissionFiles", []), "manifest should list AI Ready ASEAN mapping")
  assert_true("SOURCES.md" in data.get("submissionFiles", []), "manifest should list sources")
